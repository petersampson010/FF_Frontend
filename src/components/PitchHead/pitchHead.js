        ...
        switch(this.props.type) {
            ...
            case 'transfers':
                    return <View>
                        ...
                        <View style={{flexDirection: "row"}}><Text style={labelText}>Budget: </Text><Text style={{...labelText, color: (this.props.user.budget>=0 ? 'green' : 'red')}}>{this.props.user.budget}m</Text></View>
                    </View>;
                return 
            case 'pickTeam':
                return <Text></Text>;
